    ...
    return (
        ...
        <main className="content root">
            ...
            <section className="cards">
                ...
                return <Card card = {cardinfo} onCardClick = {props.onCardClick} likes = {card.likes} onDeleteCardPopup = {props.onDeleteCardPopup} onCardLike = {props.onCardLike} onCardDelete = {props.onCardDelete} key = {card._id}/>
            })}
            </section>
        </main>
        <Footer />
